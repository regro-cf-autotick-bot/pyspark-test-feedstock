...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyspark-test-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12861&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyspark-test-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyspark-test` can be installed with:

```
conda install pyspark-test
```

It is possible to list all of the versions of `pyspark-test` available on your platform with:
